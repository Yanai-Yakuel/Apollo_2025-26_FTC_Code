...
@Autonomous(name = "auto_no_last_intake_red", group = "drive")
public class auto_no_last_intake_red extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        drive.followTrajectory(drive.trajectoryBuilder(drive.getPoseEstimate())
                .lineToLinearHeading(new Pose2d(31.504, -19.1, Math.toRadians(-52)))
                .build());
        shoot();

        // Intake 1
        drive.followTrajectory(drive.trajectoryBuilder(drive.getPoseEstimate())
                .lineToLinearHeading(new Pose2d(5, -18, Math.toRadians(-90)))
                .build());
        ...
        drive.followTrajectory(drive.trajectoryBuilder(drive.getPoseEstimate())
                .lineToLinearHeading(new Pose2d(5, -60, Math.toRadians(-90)))
                .build());
        ...
        // Shot 2
        drive.followTrajectory(drive.trajectoryBuilder(drive.getPoseEstimate())
                .lineToLinearHeading(new Pose2d(38, -13, Math.toRadians(-52)))
                .build());
        shoot();
        ...
        // Shot 3
        drive.followTrajectory(drive.trajectoryBuilder(drive.getPoseEstimate())
                .lineToLinearHeading(new Pose2d(42, -5, Math.toRadians(-52)))
                .build());
        shoot();

        // Parking
        drive.followTrajectory(drive.trajectoryBuilder(drive.getPoseEstimate())
                .lineToLinearHeading(new Pose2d(6, -28, Math.toRadians(-90)))
                .build());
