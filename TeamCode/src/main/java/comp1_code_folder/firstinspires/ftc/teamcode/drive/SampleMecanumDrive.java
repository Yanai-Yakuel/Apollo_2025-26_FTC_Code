package comp1_code_folder.firstinspires.ftc.teamcode.drive;
...
import static comp1_code_folder.firstinspires.ftc.teamcode.drive.DriveConstants.*;

@Config
public class SampleMecanumDrive extends MecanumDrive {

    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(2.2, 0, 1.3);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(0.8, 0.0, 0);
