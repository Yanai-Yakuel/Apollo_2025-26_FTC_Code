...
//@Config
//@TeleOp(name = "far_shoot_unit_test.java", group = "drive")
public class far_shoot_unit_test extends LinearOpMode {
    ...
    public static double SHOOT_TARGET_RPM = 3000; ///2250
    ...
    public static double HOLD_MIN_PUSH = 0.07; // ×”×›×•×— ×”×ž×™× ×™×ž×œ×™ ×œ×ž× ×™×¢×ª ×¢×¦×™×¨×” ×‘-3 ××™× ×¥'
    ...
    public static double hood_open = 0.42; /// 0.47
    ...
    private void driveManual(Pose2d pose) {
        ...
        double rotX = ly * Math.cos(-botHeading) - lx * Math.sin(-botHeading);
        double rotY = ly * Math.sin(-botHeading) + lx * Math.cos(-botHeading);
