...
@Autonomous(name = "Autonomous_12_blue", group = "drive")
public class Autonomous_12_blue extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        drive.followTrajectory(drive.trajectoryBuilder(drive.getPoseEstimate())
                .lineToLinearHeading(new Pose2d(20, 65, Math.toRadians(90)))
                .build());
        ...
        /// ××™×¡×•×£ 2
        drive.followTrajectory(drive.trajectoryBuilder(drive.getPoseEstimate())
                .lineToLinearHeading(new Pose2d(-23, 25, Math.toRadians(90)))
                .build());
        ...
        drive.followTrajectory(
                drive.trajectoryBuilder(drive.getPoseEstimate())
                        .splineToLinearHeading(
                                new Pose2d(42, 5, Math.toRadians(52)),
                                Math.toRadians(52)
                        )
                        .build()
        );
        ...
        // ×ž×¢×‘×¨
        drive.followTrajectory(drive.trajectoryBuilder(drive.getPoseEstimate())
                .lineToLinearHeading(new Pose2d(65, 0, Math.toRadians(75)))
                .build());
